    ...
    >
      <div className="text-center">
        <div ref={textRef} className="mb-8">
          ...
          <p className="text-muted-foreground text-lg tracking-wider">Loading Portfolio...</p>
        </div>
      ...
      <div className="floating-orb w-24 h-24 top-3/4 right-1/4 animate-float" style={{ animationDelay: '2s' }} />
      <div className="floating-orb w-20 h-20 bottom-1/4 left-1/2 animate-float" style={{ animationDelay: '4s' }} />
    </div>
  );
};