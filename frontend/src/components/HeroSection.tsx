...
export const HeroSection = () => {
  ...
  return (
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="hero-orb floating-orb w-32 h-32 top-1/3 right-20 animate-float" style={{ animationDelay: '2s' }} />
      <div className="hero-orb floating-orb w-20 h-20 bottom-40 left-1/4 animate-float" style={{ animationDelay: '4s' }} />
